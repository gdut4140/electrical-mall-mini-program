        ...
        <view class="header">
            <view class="search-box">
                <view class="search-input-wrapper">
                    ...
                    <input type="text" v-model="searchKeyword" placeholder="搜索积分商品..." placeholder-style="color:#999"
            ...
            <view class="product-card" v-for="(item, index) in products" :key="item.id || index">
                ...
                <view class="product-info">
                    ...
                    <view class="product-bottom">
                        <text class="product-price">{{ item.pointsPrice || item.price }} 积分</text>
...
import { getPointsProducts, getWechatQrcode } from '@/api/apiMethods';
...
const fetchProducts = async () => {
    ...
    try {
        const data = await getPointsProducts(params);
